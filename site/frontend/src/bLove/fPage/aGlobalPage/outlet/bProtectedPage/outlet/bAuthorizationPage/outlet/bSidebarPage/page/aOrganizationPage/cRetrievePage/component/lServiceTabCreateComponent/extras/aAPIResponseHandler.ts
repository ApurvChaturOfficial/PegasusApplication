...
const apiResponseHandler = {
  createAPIResponseHandler: async (data: any, createAPITrigger: any, navigate: any) => {
    try {
  ...
  updateAPIResponseHandler: async (data: any, updateAPITrigger: any, navigate: any, enrolledServiceCreateAPITrigger: any, organizationRetrieve: any) => {
    try {
